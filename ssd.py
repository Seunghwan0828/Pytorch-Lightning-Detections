...
class TrainingModule(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        self.log(
            'loss', losses, on_step=True, on_epoch=False, prog_bar=False
        )
        self.log(
            'class_loss', loss_dict['classification'], on_step=True, on_epoch=False, prog_bar=False
        )
        self.log(
            'box_loss', loss_dict['bbox_regression'], on_step=True, on_epoch=False, prog_bar=False
        )
...
if __name__ == '__main__':
    ...
    parser.add_argument('--project', type=str, default='my_ssd')
    parser.add_argument('--weight_path', type=str, default='weights/ssd/')
    ...
    parser.add_argument('--checkpoint', type=str, default='coco_weights/ssd/best.ckpt')
